...
The pi is running a script named accesspopup to handle automstic wifi hotspot. More info available at https://www.raspberryconnect.com/projects/65-raspberrypi-hotspot-accesspoints/203-automated-switching-accesspoint-wifi-network
please read it!
...
First, you may power the unit vie its mr30 connector and then connect via a simple ethernet to usb c adapter.
You may also choose to use a ethernet + poe to usb c + pd converter to supply both power and data to your unit over one wire.
